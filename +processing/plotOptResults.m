function output_txt = plotOptResults(~, event_obj, obj)
...
CurrentObject = positionParent.createObject(...
    obj.getStructure(obj.History.TestedGens(pos(1),:)));
...
clf(obj.ProfitPlot)
set(0,'CurrentFigure',obj.ProfitPlot)
...
legend(strrep(obj.TaskName, '_', ' '),'Location','NorthWest')
